...
ACCEPTED_TEXT = "Hi {user}\n\nನಿಮ್ಮ ವಿನಂತಿ {chat} ಮೂವಿ ಚಾನೆಲ್ ಗೆ ಸ್ವೀಕರಿಸಲಾಗಿದೆ ✅\n\n𝗝𝗢𝗜𝗡: @Kr_CineHub For ಕನ್ನಡ ಹೊಸ ಸಿನಿಮಾ \n\n📥 𝗦𝗲𝗻𝗱 👉 /start 𝗧𝗼 𝗚𝗲𝘁 𝗞𝗮𝗻𝗻𝗮𝗱𝗮 𝗥𝗼𝗰𝗸𝗲𝗿𝘀 𝗖𝗶𝗻𝗲𝗛𝘂𝗯.\n\n𝗝𝗢𝗜𝗡👇👇\n{joinlink}"
START_TEXT = "Hai {}\n\nI am Auto Request Accept Bot With Working For All Channel. Add Me In Your Channel To Use\n\n🇰 annada 🇷 ockers 🇨 ineHub\n\n𝗝𝗢𝗜𝗡👇👇\n{}"
...
async def start_handler(c, m):
    ...
    lazydeveloper_btn = [[
        InlineKeyboardButton('❤ KR CINEHUB 🍟', url='https://t.me/+OQW32goxjsk0ZDk1')
    ]]
    joinlink = f"https://t.me/+OQW32goxjsk0ZDk1"
